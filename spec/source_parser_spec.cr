...
describe Ruby2CR::SourceParser do
  describe ".parse_source" do
    ...
    it "defaults to Ruby parsing for unknown extensions" do
      ast = Ruby2CR::SourceParser.parse_source("x = 1", "test.txt")
      ast.to_s.should contain "x = 1"
    end
  end
end
