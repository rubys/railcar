# Crystal source for the TypeScript runtime base classes.
#
# This file serves one purpose:
#   program.semantic() types it so models inheriting from it get type info.
#
# The actual runtime is base_runtime.ts (hand-written TypeScript).
# This Crystal stub mirrors the TypeScript API surface for type inference.
...
module Railcar
  ...
  class ApplicationRecord
    ...
    # Callback stubs for program.semantic()
    ...
    # Broadcast stubs for program.semantic()
