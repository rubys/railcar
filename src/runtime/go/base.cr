# Crystal source for the Go runtime base classes.
#
# This file serves one purpose:
#   program.semantic() types it so models inheriting from it get type info.
#
# The actual runtime is railcar.go (hand-written Go).
# This Crystal stub mirrors the Go API surface for type inference.
